---
title: Setup an Identity Provider
description: Deploy your own OpenApe IdP with DNS, storage, and Passkey authentication.
---
...
::callout{type="info"}
If this is a fresh IdP with no users yet, create a registration URL first via the admin API. See the [API Reference](/reference/api-endpoints) for `POST /api/admin/registration-urls`.
::

## What's Next?

- [End-to-End Tutorial](/getting-started/end-to-end-tutorial) — Full walkthrough with IdP, SP, and Agent
- [Agent Integration](/getting-started/agent-integration) — Enroll agents and use grants
- [IdP Configuration Reference](/reference/idp-configuration) — All configuration options
- [Deployment Guide](/operations/deployment) — Production deployment with Vercel or Docker
