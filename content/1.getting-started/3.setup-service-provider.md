---
title: Setup a Service Provider
description: Add OpenApe authentication to your app in 3 steps.
---
...
- No DNS record for a user's domain? The **fallback IdP** ([id.openape.at](https://id.openape.at)) handles it — free, zero-setup
- Users who want full control can run their own IdP with [`@openape/nuxt-auth-idp`](/getting-started/setup-identity-provider)
