...
description: Step-by-step guide to enrolling agents, requesting grants, and using AuthZ-JWTs.
---

# Agent Integration

This guide walks through the complete agent lifecycle: enrollment, authentication, grant request, approval, and token usage.
