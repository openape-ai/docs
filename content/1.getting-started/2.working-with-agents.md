...
description: Set up OpenApe agent gatekeeping for AI agents like OpenClaw.
---

# Working with Agents

This guide sets up the three [Agent Gate Applications](/ecosystem) to control what your AI agent can do. Every command the agent executes will require a grant — approved by a human.

The examples use [OpenClaw](https://openclaw.ai) as the agent, but the setup works with any agent that runs CLI commands.

## Prerequisites

- A running OpenClaw instance
- An OpenApe IdP (use the public `https://id.openape.at` or [run your own](/getting-started/setup-identity-provider))
