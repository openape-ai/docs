...
- **Zero config in development** — session secrets are auto-generated, `spId` is derived from your dev server port
...
|---------|-------------|-------------|
| `spId` | `NUXT_OPENAPE_SP_SP_ID` | Your service identifier (e.g. `myapp.example.com`) |
