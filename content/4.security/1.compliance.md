...
- **[escapes](/ecosystem/escapes) audit log** — JSONL with command, grant ID, timestamp, result

For audit log formats and monitoring recommendations, see the [Monitoring Guide](/operations/monitoring).
